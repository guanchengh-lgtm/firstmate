...
const existingReplacementCoordinator = replacementCoordinators.get(actionableHandoff);
const replacementCoordinator: ReplacementCoordinator =
  existingReplacementCoordinator ?? {
    receiver: null,
    pending: [],
    nextTokenId: 0,
    deliveries: new Map(),
  };
if (!existingReplacementCoordinator) {
