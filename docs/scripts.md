...
| `fm-owner-invoke-wait-check.sh` | Refuse a locked next act, an OWNER_INVOKE_WAIT marker, or durable ship records missing an OV worker/report or plan-eng-review load |
