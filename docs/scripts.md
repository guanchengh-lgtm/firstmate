...
| `fm-primary-scope-lib.sh` | Shared marker-or-plain-checkout primary-home predicate for tracked hooks; a leftover secondmate marker on a linked worktree stays inert |
