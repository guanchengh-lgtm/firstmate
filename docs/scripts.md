...
| `fm-owner-invoke-wait-check.sh` | Refuse a locked next act, an OWNER_INVOKE_WAIT marker, a missing OV report, or ship instructions that never loaded plan-eng-review |
