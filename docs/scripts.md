...
| `fm-owner-invoke-wait-check.sh` | Refuse a locked next act, an OWNER_INVOKE_WAIT marker, a this-session captain owner-invoke without its deliverable, a north-star or captain.md citation without a last-AMENDED receipt, or this session's ships whose OV review is gone without a report or (Claude ov_harness only) never loaded plan-eng-review |
