...
FM_FLEET_PRUNE=1        # set to 0 to skip guarded cleanup of local branches whose upstream is gone
...
FM_HEARTBEAT_SCAN_SECS=300         # cadence of the catch-all unread-status-span scan for missed captain-relevant events
