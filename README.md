...
| `/updatefirstmate` | Self-update the running firstmate and its secondmates from upstream when configured, otherwise origin, with fast-forward-only pulls, then re-read instructions and nudge secondmates |
