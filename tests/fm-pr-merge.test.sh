...
#   (r) --method=<value> is translated to the gh shorthand gh accepts
#   (s) --match-head-commit is delivered to gh, never gh-axi which drops it
#   (t) a red GitHub forge rollup refuses before the merge command
set -u
