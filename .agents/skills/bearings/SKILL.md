...
- An unavailable secondmate home, including a registered home that no longer exists, contributes nothing to Recently Landed, Charted Next, or Captain's Call, so render its Charted Next row together with the related `omitted` warning and never present that missing contribution as an empty or complete baseline.
