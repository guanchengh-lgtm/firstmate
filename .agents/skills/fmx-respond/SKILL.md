...
This skill is the sole owner of the completion-follow-up procedure below; `AGENTS.md` section 8 and section 14 declare the load triggers for Relay events, milestones, and terminal outcomes.
