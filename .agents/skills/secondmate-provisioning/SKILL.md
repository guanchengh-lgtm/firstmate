...
For remote provisioning, including supplied project origins and the no-primary-project-tree contract, follow [`docs/remote-secondmates.md`](../../../docs/remote-secondmates.md#provision-a-route); [`bin/fm-project-origin-lib.sh`](../../../bin/fm-project-origin-lib.sh) owns the accepted origin forms.
