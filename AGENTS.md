...
config/update-remote  optional self-update remote name; LOCAL, gitignored, and not inherited; absent or empty = upstream when present, otherwise origin; see docs/configuration.md "Self-update remote"
config/issue-intake.json  optional labeled GitHub issue intake; LOCAL, gitignored, and not inherited; see docs/configuration.md "GitHub issue intake"
