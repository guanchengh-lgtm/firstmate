...
#       hook that outlives its incarnation fails closed here. Firstmate recovery
#       paths (fm-recovery), and compatibility with older fm-interrupt records,
#       may pass --current-gen to bind to the incarnation armed right now.
#
