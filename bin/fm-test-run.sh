...
family_for_basename() {
  case "$1" in
    ...
    fm-pr-check-breakage.test.sh|fm-check-unregister.test.sh|\
...
tests/fm-backend-cmux.test.sh 3989
tests/fm-backend-herdr-focus-flash-e2e.test.sh 23
tests/fm-backend-orca.test.sh 23864
tests/fm-backend-tmux-smoke.test.sh 542
tests/fm-backend-zellij-smoke.test.sh 23
tests/fm-backend-zellij.test.sh 10056
tests/fm-backend.test.sh 23007
tests/fm-backlog-atomicity.test.sh 122256
tests/fm-backlog-handoff.test.sh 52291
tests/fm-bash32-array-expansion.test.sh 58
tests/fm-bearings-board-render.test.sh 1773
tests/fm-bearings-board.test.sh 4491
tests/fm-bearings-snapshot.test.sh 111939
tests/fm-bootstrap-network-parallel.test.sh 11849
tests/fm-bootstrap.test.sh 69610
tests/fm-branch-supervision.test.sh 8109
tests/fm-busy-adapter-wiring.test.sh 19827
...
tests/fm-classify-decision-key.test.sh 1215
tests/fm-claude-stop-autoarm-live-e2e.test.sh 30
tests/fm-claude-stop-autoarm.test.sh 60753
...
tests/fm-control-relaunch.test.sh 60537
tests/fm-control.test.sh 37941
tests/fm-cursor-harness.test.sh 30103
tests/fm-cursor-primary-live-e2e.test.sh 21
tests/fm-cursor-primary.test.sh 59420
tests/fm-daemon.test.sh 26870
tests/fm-deadman.test.sh 4620
tests/fm-documentation-audiences.test.sh 732
tests/fm-extension-binding.test.sh 7398
tests/fm-feeder-export.test.sh 406764
tests/fm-fleet-snapshot-view.test.sh 9364
tests/fm-fleet-sync.test.sh 38454
tests/fm-gate-refuse.test.sh 6231
tests/fm-gitignore-config.test.sh 63
tests/fm-gotmp.test.sh 1805
tests/fm-grill-with-docs-invocation.test.sh 748
...
tests/fm-harness-liveness-drift-live-e2e.test.sh 22
tests/fm-herdr-session-cleanup.test.sh 14120
tests/fm-herdr-submit-confirm-live-e2e.test.sh 29
...
tests/fm-issue-intake.test.sh 3336
tests/fm-kimi-harness.test.sh 22578
tests/fm-lint-agentsmd-budget.test.sh 30000
tests/fm-lint-workflows.test.sh 857
tests/fm-map-fog-check.test.sh 1167
...
tests/fm-operational-input.test.sh 260
tests/fm-ov-backpass-apply.test.sh 782
tests/fm-owner-invoke-wait-check.test.sh 3152
tests/fm-peek-remote.test.sh 1018
tests/fm-pending-reply.test.sh 26122
tests/fm-pi-branch-extension.test.sh 47981
tests/fm-pi-branch-live-e2e.test.sh 56
tests/fm-pi-midline-slash-patch.test.sh 287
tests/fm-pi-primary-live-e2e.test.sh 41
tests/fm-pi-watch-extension.test.sh 48930
tests/fm-pr-attestation-live.test.sh 4286
...
tests/fm-secondmate-reconcile.test.sh 63001
tests/fm-secondmate-safety.test.sh 58656
tests/fm-secondmate-sync.test.sh 29236
tests/fm-send-inbox-doorbell-live-e2e.test.sh 27
tests/fm-send-inbox.test.sh 40010
...
tests/fm-send-secondmate-marker.test.sh 6697
tests/fm-session-lock-ancestry.test.sh 12268
tests/fm-session-start.test.sh 176881
...
tests/fm-sot-pointer-check.test.sh 17883
tests/fm-spawn-dispatch-profile.test.sh 131996
tests/fm-spawn-pool-base-freshen.test.sh 34920
tests/fm-spawn-treehouse-pool-exhaustion.test.sh 2087
tests/fm-spawn-worktree-settle.test.sh 6133
tests/fm-startup-memory-budget.test.sh 7168
tests/fm-startup-network.test.sh 63077
tests/fm-stow-cascade.test.sh 3101
tests/fm-stow-open-lock-check.test.sh 936
tests/fm-subagent-pretool-check.test.sh 1066
tests/fm-supervision-events.test.sh 1431
tests/fm-tangle-guard.test.sh 9999
tests/fm-task-delivery.test.sh 13399
tests/fm-task-inbox.test.sh 25369
tests/fm-teardown-endpoint-safety.test.sh 7295
tests/fm-teardown.test.sh 144119
tests/fm-test-fixture-cleanup.test.sh 915
tests/fm-test-fixtures.test.sh 153
tests/fm-test-isolation-proof.test.sh 2764
tests/fm-tmux-agent-liveness.test.sh 4065
tests/fm-tool-update-check.test.sh 14377
tests/fm-trace-context-lib.test.sh 278
tests/fm-trace-context-spawn.test.sh 50314
tests/fm-turnend-guard.test.sh 67208
tests/fm-update.test.sh 10315
tests/fm-validation-truth.test.sh 7281
tests/fm-vendor-auth-probe.test.sh 43316
tests/fm-voice-relay.test.sh 33202
tests/fm-wake-daemon-lifecycle-e2e.test.sh 7381
tests/fm-wake-drain-open-decisions-cursor.test.sh 21390
tests/fm-wake-drain-open-decisions.test.sh 11300
tests/fm-wake-drain-outcome-backstop.test.sh 43866
tests/fm-wake-drain-unread-status.test.sh 35078
tests/fm-wake-queue.test.sh 61653
tests/fm-watch-arm.test.sh 81238
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-stow-cascade.sh)
      printf '%s\n' secondmate
      ;;
    bin/fm-prior-session-fold.sh|bin/fm-session-start.sh|bin/fm-bootstrap.sh|bin/fm-fleet-sync.sh|\
    bin/fm-sessionstart-nudge.sh|bin/fm-startup-network.sh|bin/fm-tangle*|bin/fm-update.sh|\
    bin/fm-gate-refuse*|bin/fm-lock*)
      printf '%s\n' session-bootstrap
      ;;
    bin/fm-pi-midline-slash-patch.sh)
      printf '%s\n' pure-contract-unit
      printf '%s\n' session-bootstrap
      ;;
