...
# The generated DOD still carries human-readable "Delivery contract: mode=<mode>"
# and "Role: builder" lines; the launch gate in bin/fm-spawn.sh reads the sibling
# mode/role marker files written after this brief.
case "$MODE" in
  direct-PR)
    SETUP2=""
